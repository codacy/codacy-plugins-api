...
object Parameter {
  ...
  object Value {
    ...
    case class Str(value: String) extends AnyVal with Parameter.Value

    case class Bool(value: Boolean) extends AnyVal with Parameter.Value

    case class Num(value: BigDecimal) extends AnyVal with Parameter.Value
